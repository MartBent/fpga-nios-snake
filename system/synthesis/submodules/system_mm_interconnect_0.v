...
module system_mm_interconnect_0 (
		...
		output wire [1:0]  score_pio_s1_address,                  //                    score_pio_s1.address
		output wire        score_pio_s1_write,                    //                                .write
		input  wire [31:0] score_pio_s1_readdata,                 //                                .readdata
		output wire [31:0] score_pio_s1_writedata,                //                                .writedata
		output wire        score_pio_s1_chipselect,               //                                .chipselect
	...
	wire   [6:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> sys_clk_timer_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> memory_s1_agent:cp_data
	...
	wire         cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> btn_pio_s1_agent:cp_valid
	wire  [96:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> btn_pio_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // btn_pio_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> btn_pio_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> btn_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> btn_pio_s1_agent:cp_endofpacket
	...
	wire  [20:0] frame_buffer_s1_agent_m0_address;                                          // frame_buffer_s1_agent:m0_address -> frame_buffer_s1_translator:uav_address
	...
	wire  [97:0] frame_buffer_s1_agent_rf_source_data;                                      // frame_buffer_s1_agent:rf_source_data -> frame_buffer_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] frame_buffer_s1_agent_rsp_fifo_out_data;                                   // frame_buffer_s1_agent_rsp_fifo:out_data -> frame_buffer_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> frame_buffer_s1_agent:cp_valid
	wire  [96:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> frame_buffer_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // frame_buffer_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> frame_buffer_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> frame_buffer_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> frame_buffer_s1_agent:cp_endofpacket
	wire  [31:0] score_pio_s1_agent_m0_readdata;                                            // score_pio_s1_translator:uav_readdata -> score_pio_s1_agent:m0_readdata
	wire         score_pio_s1_agent_m0_waitrequest;                                         // score_pio_s1_translator:uav_waitrequest -> score_pio_s1_agent:m0_waitrequest
	wire         score_pio_s1_agent_m0_debugaccess;                                         // score_pio_s1_agent:m0_debugaccess -> score_pio_s1_translator:uav_debugaccess
	wire  [20:0] score_pio_s1_agent_m0_address;                                             // score_pio_s1_agent:m0_address -> score_pio_s1_translator:uav_address
	wire   [3:0] score_pio_s1_agent_m0_byteenable;                                          // score_pio_s1_agent:m0_byteenable -> score_pio_s1_translator:uav_byteenable
	wire         score_pio_s1_agent_m0_read;                                                // score_pio_s1_agent:m0_read -> score_pio_s1_translator:uav_read
	wire         score_pio_s1_agent_m0_readdatavalid;                                       // score_pio_s1_translator:uav_readdatavalid -> score_pio_s1_agent:m0_readdatavalid
	wire         score_pio_s1_agent_m0_lock;                                                // score_pio_s1_agent:m0_lock -> score_pio_s1_translator:uav_lock
	wire  [31:0] score_pio_s1_agent_m0_writedata;                                           // score_pio_s1_agent:m0_writedata -> score_pio_s1_translator:uav_writedata
	wire         score_pio_s1_agent_m0_write;                                               // score_pio_s1_agent:m0_write -> score_pio_s1_translator:uav_write
	wire   [2:0] score_pio_s1_agent_m0_burstcount;                                          // score_pio_s1_agent:m0_burstcount -> score_pio_s1_translator:uav_burstcount
	wire         score_pio_s1_agent_rf_source_valid;                                        // score_pio_s1_agent:rf_source_valid -> score_pio_s1_agent_rsp_fifo:in_valid
	wire  [97:0] score_pio_s1_agent_rf_source_data;                                         // score_pio_s1_agent:rf_source_data -> score_pio_s1_agent_rsp_fifo:in_data
	wire         score_pio_s1_agent_rf_source_ready;                                        // score_pio_s1_agent_rsp_fifo:in_ready -> score_pio_s1_agent:rf_source_ready
	wire         score_pio_s1_agent_rf_source_startofpacket;                                // score_pio_s1_agent:rf_source_startofpacket -> score_pio_s1_agent_rsp_fifo:in_startofpacket
	wire         score_pio_s1_agent_rf_source_endofpacket;                                  // score_pio_s1_agent:rf_source_endofpacket -> score_pio_s1_agent_rsp_fifo:in_endofpacket
	wire         score_pio_s1_agent_rsp_fifo_out_valid;                                     // score_pio_s1_agent_rsp_fifo:out_valid -> score_pio_s1_agent:rf_sink_valid
	wire  [97:0] score_pio_s1_agent_rsp_fifo_out_data;                                      // score_pio_s1_agent_rsp_fifo:out_data -> score_pio_s1_agent:rf_sink_data
	wire         score_pio_s1_agent_rsp_fifo_out_ready;                                     // score_pio_s1_agent:rf_sink_ready -> score_pio_s1_agent_rsp_fifo:out_ready
	wire         score_pio_s1_agent_rsp_fifo_out_startofpacket;                             // score_pio_s1_agent_rsp_fifo:out_startofpacket -> score_pio_s1_agent:rf_sink_startofpacket
	wire         score_pio_s1_agent_rsp_fifo_out_endofpacket;                               // score_pio_s1_agent_rsp_fifo:out_endofpacket -> score_pio_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> score_pio_s1_agent:cp_valid
	wire  [96:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> score_pio_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // score_pio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> score_pio_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> score_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> score_pio_s1_agent:cp_endofpacket
	...
	wire  [96:0] memory_s1_agent_rp_data;                                                   // memory_s1_agent:rp_data -> router_005:sink_data
	...
	wire         btn_pio_s1_agent_rp_valid;                                                 // btn_pio_s1_agent:rp_valid -> router_006:sink_valid
	wire  [96:0] btn_pio_s1_agent_rp_data;                                                  // btn_pio_s1_agent:rp_data -> router_006:sink_data
	wire         btn_pio_s1_agent_rp_ready;                                                 // router_006:sink_ready -> btn_pio_s1_agent:rp_ready
	wire         btn_pio_s1_agent_rp_startofpacket;                                         // btn_pio_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         btn_pio_s1_agent_rp_endofpacket;                                           // btn_pio_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         frame_buffer_s1_agent_rp_valid;                                            // frame_buffer_s1_agent:rp_valid -> router_007:sink_valid
	wire  [96:0] frame_buffer_s1_agent_rp_data;                                             // frame_buffer_s1_agent:rp_data -> router_007:sink_data
	wire         frame_buffer_s1_agent_rp_ready;                                            // router_007:sink_ready -> frame_buffer_s1_agent:rp_ready
	wire         frame_buffer_s1_agent_rp_startofpacket;                                    // frame_buffer_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         frame_buffer_s1_agent_rp_endofpacket;                                      // frame_buffer_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         score_pio_s1_agent_rp_valid;                                               // score_pio_s1_agent:rp_valid -> router_008:sink_valid
	wire  [96:0] score_pio_s1_agent_rp_data;                                                // score_pio_s1_agent:rp_data -> router_008:sink_data
	wire         score_pio_s1_agent_rp_ready;                                               // router_008:sink_ready -> score_pio_s1_agent:rp_ready
	wire         score_pio_s1_agent_rp_startofpacket;                                       // score_pio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         score_pio_s1_agent_rp_endofpacket;                                         // score_pio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         btn_pio_s1_agent_rdata_fifo_src_valid;                                     // btn_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] btn_pio_s1_agent_rdata_fifo_src_data;                                      // btn_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         btn_pio_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_004:in_0_ready -> btn_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> btn_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> btn_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                         // btn_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> btn_pio_s1_agent:rdata_fifo_sink_error
	wire         frame_buffer_s1_agent_rdata_fifo_src_valid;                                // frame_buffer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] frame_buffer_s1_agent_rdata_fifo_src_data;                                 // frame_buffer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         frame_buffer_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_005:in_0_ready -> frame_buffer_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> frame_buffer_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> frame_buffer_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // frame_buffer_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> frame_buffer_s1_agent:rdata_fifo_sink_error
	wire         score_pio_s1_agent_rdata_fifo_src_valid;                                   // score_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] score_pio_s1_agent_rdata_fifo_src_data;                                    // score_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         score_pio_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_006:in_0_ready -> score_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> score_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> score_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // score_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> score_pio_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) score_pio_s1_translator (
		.clk                    (clk138_clk_clk),                        //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (score_pio_s1_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (score_pio_s1_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (score_pio_s1_agent_m0_read),            //                         .read
		.uav_write              (score_pio_s1_agent_m0_write),           //                         .write
		.uav_waitrequest        (score_pio_s1_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (score_pio_s1_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (score_pio_s1_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (score_pio_s1_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (score_pio_s1_agent_m0_writedata),       //                         .writedata
		.uav_lock               (score_pio_s1_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (score_pio_s1_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (score_pio_s1_address),                  //      avalon_anti_slave_0.address
		.av_write               (score_pio_s1_write),                    //                         .write
		.av_readdata            (score_pio_s1_readdata),                 //                         .readdata
		.av_writedata           (score_pio_s1_writedata),                //                         .writedata
		.av_chipselect          (score_pio_s1_chipselect),               //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk138_clk_clk),                                //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (score_pio_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (score_pio_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (score_pio_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (score_pio_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (score_pio_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (score_pio_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (score_pio_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (score_pio_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (score_pio_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (score_pio_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (score_pio_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (score_pio_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (score_pio_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (score_pio_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (score_pio_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (score_pio_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (score_pio_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (score_pio_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (score_pio_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (score_pio_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (score_pio_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (score_pio_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (score_pio_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (score_pio_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (score_pio_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (score_pio_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),             //                .error
		.rdata_fifo_src_ready    (score_pio_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (score_pio_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (score_pio_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) score_pio_s1_agent_rsp_fifo (
		.clk               (clk138_clk_clk),                                //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (score_pio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (score_pio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (score_pio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (score_pio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (score_pio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (score_pio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (score_pio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (score_pio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (score_pio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (score_pio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	system_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (score_pio_s1_agent_rp_ready),           //      sink.ready
		.sink_valid         (score_pio_s1_agent_rp_valid),           //          .valid
		.sink_data          (score_pio_s1_agent_rp_data),            //          .data
		.sink_startofpacket (score_pio_s1_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (score_pio_s1_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk138_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk138_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (score_pio_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (score_pio_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (score_pio_s1_agent_rdata_fifo_src_ready), //         .ready
