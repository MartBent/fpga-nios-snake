...
module system_mm_interconnect_0 (
	...
	wire  [21:0] jtag_avalon_jtag_slave_agent_m0_address;                                   // jtag_avalon_jtag_slave_agent:m0_address -> jtag_avalon_jtag_slave_translator:uav_address
	...
	wire  [98:0] jtag_avalon_jtag_slave_agent_rf_source_data;                               // jtag_avalon_jtag_slave_agent:rf_source_data -> jtag_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [98:0] jtag_avalon_jtag_slave_agent_rsp_fifo_out_data;                            // jtag_avalon_jtag_slave_agent_rsp_fifo:out_data -> jtag_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> jtag_avalon_jtag_slave_agent:cp_data
	...
	wire  [21:0] cpu_debug_mem_slave_agent_m0_address;                                      // cpu_debug_mem_slave_agent:m0_address -> cpu_debug_mem_slave_translator:uav_address
	...
	wire  [21:0] sys_clk_timer_s1_agent_m0_address;                                         // sys_clk_timer_s1_agent:m0_address -> sys_clk_timer_s1_translator:uav_address
	...
	wire  [97:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> sys_clk_timer_s1_agent:cp_data
	...
	wire  [98:0] memory_s1_agent_rf_source_data;                                            // memory_s1_agent:rf_source_data -> memory_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] memory_s1_agent_rsp_fifo_out_data;                                         // memory_s1_agent_rsp_fifo:out_data -> memory_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> memory_s1_agent:cp_data
	...
	wire  [21:0] btn_pio_s1_agent_m0_address;                                               // btn_pio_s1_agent:m0_address -> btn_pio_s1_translator:uav_address
	...
	wire  [98:0] btn_pio_s1_agent_rf_source_data;                                           // btn_pio_s1_agent:rf_source_data -> btn_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] btn_pio_s1_agent_rsp_fifo_out_data;                                        // btn_pio_s1_agent_rsp_fifo:out_data -> btn_pio_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> btn_pio_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // btn_pio_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> btn_pio_s1_agent:cp_channel
	...
	wire  [21:0] frame_buffer_s1_agent_m0_address;                                          // frame_buffer_s1_agent:m0_address -> frame_buffer_s1_translator:uav_address
	...
	wire  [98:0] frame_buffer_s1_agent_rf_source_data;                                      // frame_buffer_s1_agent:rf_source_data -> frame_buffer_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] frame_buffer_s1_agent_rsp_fifo_out_data;                                   // frame_buffer_s1_agent_rsp_fifo:out_data -> frame_buffer_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> frame_buffer_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // frame_buffer_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> frame_buffer_s1_agent:cp_channel
	...
	wire  [97:0] jtag_avalon_jtag_slave_agent_rp_data;                                      // jtag_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [97:0] sys_clk_timer_s1_agent_rp_data;                                            // sys_clk_timer_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [97:0] memory_s1_agent_rp_data;                                                   // memory_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [97:0] btn_pio_s1_agent_rp_data;                                                  // btn_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [97:0] frame_buffer_s1_agent_rp_data;                                             // frame_buffer_s1_agent:rp_data -> router_007:sink_data
